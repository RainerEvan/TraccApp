...
export class EditProfileComponent implements OnInit {
  ...
  constructor(public dialogService:DialogService, public ref: DynamicDialogRef, public config: DynamicDialogConfig, private accountService: AccountService, private divisionService: DivisionService, private formBuilder: FormBuilder) { }
